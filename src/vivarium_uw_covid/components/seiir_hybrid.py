...
def individual_hybrid_step(df, s_compartment, mixing_parameter, alpha, beta_agent, beta_compartment, gamma1, gamma2, sigma, theta, testing_rate):
    ...
    return agent_covid_step_with_infection_rate(df, infection_rate, alpha, gamma1, gamma2, sigma, theta, testing_rate)
               

def run_hybrid_model(n_draws, n_simulants, mixing_parameter, params,
                     beta_agent, beta_compartment,
                     start_time, testing_rate,
