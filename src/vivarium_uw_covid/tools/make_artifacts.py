...
from vivarium_uw_covid import globals as project_globals
from vivarium_uw_covid.utilities import sanitize_location, delete_if_exists, len_longest_location
from vivarium_uw_covid.tools.app_logging import add_logging_sink, decode_status
...
def build_single_location_artifact(path: Union[str, Path], location: str, log_to_file: bool = False):
    ...
    from vivarium_uw_covid.data import builder
