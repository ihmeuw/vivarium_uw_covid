...
``src/vivarium_uw_covid/model_specifications``.
...
from vivarium_uw_covid import paths
import vivarium_uw_covid.globals as project_globals

from vivarium_uw_covid.tools import configure_logging_to_terminal
from vivarium_uw_covid.tools import build_model_specifications
from vivarium_uw_covid.tools import build_artifacts
...
def make_specs(template: str, location: str, output_dir: str, verbose: int, with_debugger: bool) -> None:
    ...
    ``src/vivarium_uw_covid/model_specification/model_spec.in``
    """
